...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _googleLogin() async {
    try {
      ...
      if (!mounted) return;
      final success =
          await ref.read(authProvider.notifier).googleLogin(tokenData: tokenData);
      if (!mounted) return;
      if (success) {
  ...
  Future<void> _register() async {
    ...
    // Error is shown via the provider state — no extra code needed
  }
                  ...
                  children: [
                    ...
                    AppTextField(
                      ...
                      validator: (val) {
                        ...
                        .slideY(begin: 0.15, end: 0, duration: 500.ms, delay: 280.ms),
                    ...
                    AppTextField(
                      ...
                      validator: (val) {
                        ...
                        .slideY(begin: 0.15, end: 0, duration: 500.ms, delay: 350.ms),
                    ...
                    AppTextField(
                      ...
                      validator: (val) {
                        ...
                        .slideY(begin: 0.15, end: 0, duration: 500.ms, delay: 420.ms),
                    ...
                    AppTextField(
                      ...
                      validator: (val) {
                        ...
                        .animate()
                        .fade(duration: 500.ms, delay: 490.ms)
                        .slideY(begin: 0.15, end: 0, duration: 500.ms, delay: 490.ms),
                    ...
                    AppButton(
                      ...
                      variant: AppButtonVariant.gradient,
                        ...
                        .animate()
                        .fade(duration: 500.ms, delay: 560.ms)
                        .slideY(begin: 0.2, end: 0, duration: 500.ms, delay: 560.ms),
                    ...
                    GoogleSignInButton(onPressed: _googleLogin)
                        .animate()
                        .fade(duration: 500.ms, delay: 640.ms)
                    ...
                    ).animate().fade(duration: 500.ms, delay: 640.ms),
